...
async function main() {
  console.log('=== Iniciando Execução da 3ª Rodada de Tratamento no Supabase (Asteriscos e Minúsculas) ===');
  ...
  const backupPath = path.resolve(__dirname, 'backup_tratamento_dados_rodada_3_pre_update.json');
  ...
  console.log('\n=== 3ª Rodada concluída com sucesso! ===');
}
