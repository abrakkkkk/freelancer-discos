...
async function main() {
  console.log('=== Iniciando Execução da 4ª Rodada de Tratamento no Supabase (Alta Certeza) ===');
  
  const relatorio = JSON.parse(fs.readFileSync(path.resolve(__dirname, 'curadoria_alta_certeza_rodada_4.json'), 'utf8'));
  ...
  const backupPath = path.resolve(__dirname, 'backup_tratamento_dados_rodada_4_pre_update.json');
  ...
  console.log('\n=== 4ª Rodada concluída com sucesso! ===');
}
